...
SET PATH=%PATH%;D:\home\site\deployments\tools\r\rubyinstaller-2.5.3-1-x86\bin
...
if not exist r md r
cd r 
if exist rubyinstaller-2.5.3-1-x86 goto end

echo No Ruby, need to get it!

REM Get Ruby and Rails
REM 32bit
curl -o ruby253.zip -L https://github.com/oneclick/rubyinstaller2/releases/download/rubyinstaller-2.5.3-1/rubyinstaller-2.5.3-1-x86.7z?direct
