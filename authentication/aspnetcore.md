...
You may get a completed and ready to run [sample from GitHub](https://github.com) showing the below recipe in the simplest of ASP.NET Core MVC applications.
