...
* Address the reader directly: "you". Use "we" only for Criipto's recommendations.
...
| **Incorrect** | **Correct** |
| --- | --- |
| The easiest way to enable authentication with Criipto in your application is to use the OpenID Connect middleware. | To enable authentication in your application, use the OpenID Connect (OIDC) middleware. |
